...
clear: .db $00, $ff, $ff    ; Neopixel color value for clear weather type 0026E6 or blue use lpm to access - lpm indexes into a half memory location program memory in word chunks 
overcast: .db $00, $ff, $ff 	; Neopixel color value for overcast weather type 8C999C or gray
showers: .db $00, $ff, $ff   ; Neopixel color value for showers 8C999C or electric green!
tstorms: .db $00, $ff, $ff   ; Neopixel color value for thunderstorms 8C999C or pumpkin orage!
